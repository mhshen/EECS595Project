...
if __name__ == "__main__":
    ...
    # Dataset
    ################
    raw_datasets = load_dataset("stanfordnlp/shp")
    ...
    raw_datasets = raw_datasets.map(transform_example)
    ...
    reward_config.auto_find_batch_size = True
    ...
    os.environ["WANDB_PROJECT"] = "reward_model_shp"
